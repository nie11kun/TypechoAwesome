...
<div class="col-md-3 .d-sm-none .d-md-block" id="secondary" role="complementary">
    <?php if (!empty($this->options->sidebarBlock) && in_array('ShowRecentPosts', $this->options->sidebarBlock)) : ?>
        <section class="widget">
            <h3 class="Display 2"><?php _e('最新文章'); ?></h3>
    ...
    <?php if (!empty($this->options->sidebarBlock) && in_array('ShowRecentComments', $this->options->sidebarBlock)) : ?>
        <section class="widget">
            <h3 class="Display 2"><?php _e('最近回复'); ?></h3>
            <ul class="widget-list">
    ...
    <?php if (!empty($this->options->sidebarBlock) && in_array('ShowCategory', $this->options->sidebarBlock)) : ?>
        <section class="widget">
            <h3 class="Display 2"><?php _e('分类'); ?></h3>
    ...
    <?php if (!empty($this->options->sidebarBlock) && in_array('ShowArchive', $this->options->sidebarBlock)) : ?>
        <section class="widget">
            <h3 class="Display 2"><?php _e('归档'); ?></h3>
            <ul class="widget-list">
    ...
    <?php if (!empty($this->options->sidebarBlock) && in_array('ShowOther', $this->options->sidebarBlock)) : ?>
        <section class="widget">
            <h3 class="Display 2"><?php _e('其它'); ?></h3>
            <ul class="widget-list">
